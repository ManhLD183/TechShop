...
import { Smartphone, Mail, Lock, User, ArrowRight, Github, Chrome } from 'lucide-react';
    ...
    <main className="pt-32 pb-20 px-4 flex items-center justify-center bg-black text-white min-h-screen">
      ...
      >
        <div className="text-center mb-10">
          ...
          <p className="text-gray-500 text-sm mt-2">Tham gia cùng hàng nghìn khách hàng khác</p>
        </div>

        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-2">
            <label className="text-xs font-bold tracking-widest uppercase text-gray-500 ml-1">Họ và tên</label>
          ...
          <div className="space-y-2">
            <label className="text-xs font-bold tracking-widest uppercase text-gray-500 ml-1">Mật khẩu</label>
            <div className="relative">
